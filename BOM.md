# Bulletproof Drybox Bill of Materials (BOM)
Reminder: This is a **prototype**, and the BOM below is provided for inspiration and reference.
Many of the items listed are items I had on hand from other projects, not all supplies are listed, (wire and connectors, silicone, etc).

Any suggestions for hardware improvements are quite welcome, any time!
